...
int main() {
	...
	fr(tmp4,1,T+1) {
		...
		if(mat[st.first][st.second].dang[0]==1 || mat[st.first][st.second].dang[1]==1 || mat[st.first][st.second].dang[2]==1 || mat[st.first][st.second].dang[3]==1) {
			...
			while(!Q.empty()) {
				...
				//pf("\n%c %d %d %d\n",mat[ptmp1.first][ptmp1.second+1].item,mat[ptmp1.first][ptmp1.second+1].dang[(mat[ptmp1.first][ptmp1.second].dist+1)%4],mat[ptmp1.first][ptmp1.second+1].dist,mat[ptmp1.first][ptmp1.second].dist);
